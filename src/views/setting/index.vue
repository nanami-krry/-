<template>
  <div class="dashboard-container">
    ...
    <el-dialog :close-on-click-modal="false" title="分配权限" :visible="showPermDialog" @close="btnPermCancel">
      <!-- 权限是一颗树 -->
      <!-- 将数据绑定到组件上 -->
...
import { getRoleList, deleteRole, updateRole, getRoleDetail, addRole, getCompanyInfo, assignPerm } from '@/api/setting'
